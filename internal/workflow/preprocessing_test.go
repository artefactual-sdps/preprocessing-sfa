...
Please review the SIP and ensure that its structure matches the DigitizedAIP specifications.`,
					Outcome:     enums.EventOutcomeValidationFailure,
					StartedAt:   testTime,
					CompletedAt: testTime,
				},
...
The name used for the package does not match the expected convention for the "DigitizedAIP" type.
...
Please review the naming conventions specified for this type of SIP.`,
				...
				{
					Name: "Verify SIP manifest",
					Message: `Content error: SIP contents do not match the "UpdatedAreldaMetadata.xml" manifest.
